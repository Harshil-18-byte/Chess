                      ...
                      Chip(
                        ...
                        label: Text(
                          activeMove != null
                              ...
                              : 'Start Position',
                          style: const TextStyle(color: BoardThemes.pureWhite, fontSize: 12),
                        ),
                      ),
                    ],
                  ),
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.bold,
                              color: isSelected ? BoardThemes.pitchBlack : BoardThemes.pureWhite,
                            ),
                          ),
                        ),
                      );
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: enabled
                ? BoardThemes.pureWhite.withValues(alpha: 0.25)
                : BoardThemes.pureWhite.withValues(alpha: 0.08),
            width: 1,
          ),
        ),
        child: Text(
          ...
          style: TextStyle(
            ...
            color: enabled ? BoardThemes.pureWhite : BoardThemes.midSlate,
          ),
        ),
      ),
    );
